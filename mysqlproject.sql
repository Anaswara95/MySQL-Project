...
select  emp_name,salary,(select avg(salary) from employee) from employee;
...
#Identify the branches where the average salary of employees is above Rs. 45,000.
...
#Identify the publisher who have the most books in the library.
